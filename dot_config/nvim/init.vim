...
if !has('gui_running')
    augroup clearWindow
        ...
        autocmd VimEnter,ColorScheme * highlight Visual ctermbg=98
        autocmd VimEnter,ColorScheme * highlight Search ctermbg=202
        autocmd VimEnter,ColorScheme * highlight CursorColumn ctermbg=235
    augroup END
