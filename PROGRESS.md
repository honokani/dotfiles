...
- 2026-05-18: `initialize_ubuntu.3.sh` から `setup_neovim` 関数削除（メニュー選択肢 1〜4 に繰り上げ）、`core.editor` を `vim` に変更して `setup_dev_tools` 末尾に移動、`npm install -g yarn neovim` の `neovim` 削除（vim 9 を使う方針に対応）
